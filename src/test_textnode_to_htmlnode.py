...
from textnode_to_htmlnode import (split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnodes)
...
class TestTextNodeToHTML(unittest.TestCase):
    ...
    def test_split_link_two_link(self):
        node = TextNode(
    ...
    def test_split_images_no_images(self):
        node = TextNode("This node has no images", TextType.TEXT,)
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
            [
    ...
    def test_text_to_textnodes_two_links(self):
        ...
        new_nodes = text_to_textnodes("This is text with a link [to boot dev](https://www.boot.dev) and [to youtube](https://www.youtube.com/@bootdotdev)")
        self.assertListEqual(
            [
            TextNode("This is text with a link ", TextType.TEXT),
            TextNode("to boot dev", TextType.LINK, "https://www.boot.dev"),
    ...
    def test_text_to_textnodes_split_images(self):
    ...
    def test_text_to_textnodes_ialic(self):
         
        new_nodes = text_to_textnodes("This is text with an _italic_ word")
        self.assertListEqual(
            [
            TextNode("This is text with an ", TextType.TEXT),
            TextNode("italic", TextType.ITALIC),
